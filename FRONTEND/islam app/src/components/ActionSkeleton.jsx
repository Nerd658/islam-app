...
export default function ActionSkeleton() {
    return (
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 -mx-4 px-4 sm:mx-0 sm:px-0 mt-8 hide-scrollbar">
            {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="snap-center shrink-0 w-[85%] sm:w-[350px] bg-theme-surface border border-theme-border rounded-2xl p-6 shadow-sm flex flex-col gap-4 animate-pulse">
